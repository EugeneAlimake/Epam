...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        public void hasMilitaryTransportPlane()
        {
            ...
            {
                Assert.IsTrue(militaryPlane.GetMilitaryType() == MilitaryType.TRANSPORT);
            }
        ...
        {
            Airport airport = new Airport(planes);
            Assert.Equals(planeWithMaxPassengerCapacity, airport.GetPassengerPlaneWithMaxPassengersCapacity());
        ...
        public void SortByMaxLoadCapacity()
        {
            ...
            for (int i = 0; i < planesSortedByMaxLoadCapacity.Count - 1; i++)
            {
                ...
                Assert.IsFalse(currentPlane.MAXLoadCapacity() > nextPlane.MAXLoadCapacity());
            }
        }
    }
}
